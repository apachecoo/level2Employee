        ...
        <div class="card-body">
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="employee[name]" value="<?= $employee['name'] ?>">
                </div>
                <div class="form-group">
                    <label for="lastName">Apellido:</label>
                    <input type="text" class="form-control" id="lastName" name="employee[lastName]" value="<?= $employee['lastName'] ?>">
                </div>
                <div class="form-group">
